...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      <div className="container relative z-10 mx-auto flex min-h-screen flex-col px-4 py-24 sm:py-32">
        <div className="mx-auto flex max-w-4xl flex-1 flex-col items-center justify-center text-center">
          ...
          >
            <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-sm">
              ...
              Para quem trava quando a questão muda
            </Badge>
          </motion.div>
          ...
          {/* Vídeo */}
          <div className="mx-auto mb-8 mt-2 w-full max-w-4xl overflow-hidden rounded-2xl border border-white/10 shadow-xl">
          ...
          >
            O Treinador de Matemática Cadê o Xis foi criado para desenvolver o que mais falta na escola:
            raciocínio antes de calcular, prática direcionada e treino para ganhar segurança na hora da
            prova.
          </motion.p>
            ...
            <div className="flex items-center justify-center">
              <a href="#pricing">
                <div className="group flex h-[60px] cursor-pointer items-center gap-2 rounded-full border border-border bg-card p-[10px]">
                  ...
                  <div className="size-[24px] rounded-full border-2 border-border text-muted-foreground transition-all ease-in-out group-hover:ml-4 flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
                      height="14"
