...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden flex justify-center">
      <div className="container relative z-10 mx-auto px-4 pt-15 pb-15 md:pt-24 md:pb-15">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          ...
          >
            <Badge
              variant="secondary"
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-primary/5 px-6 py-2 text-sm text-primary"
            >
              <Sparkles className="h-5 w-4" />
              Para quem trava quando vai resolver sozinho
            </Badge>
          </motion.div>
          ...
          >
            <h1
              id="main-title"
              className="mx-auto max-w-5xl text-balance text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-6xl"
            >
              Você entende a matéria...
              <br className="hidden sm:block" />
              <span className="sm:hidden"> </span>
              mas trava quando vai
              <br className="hidden sm:block" />
              <span className="sm:hidden"> </span>
              resolver sozinho?
            </h1>
          ...
          {/* Bloco de introdução + 3 aprendizados */}
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.45, delay: 0.1 }}
            className="mx-auto mb-10 w-full max-w-3xl px-6"
          >
            <p className="mb-8 text-center text-base leading-7 text-muted-foreground md:text-xl">
              Assista à aula de introdução gratuitamente e você vai aprender 3 coisas:
            </p>

            <div className="mx-auto w-full max-w-2xl space-y-6">
              <div className="flex items-start gap-4">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-primary/70 text-sm font-bold text-primary">
                  1
                </div>
                <p className="pt-0.5 text-base leading-7 text-white/90 md:text-lg">
                  Por que você entende a explicação, mas não consegue aplicar sozinho.
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="pt-0.5 text-base leading-7 text-white/90 md:text-lg">
                  O que fazer quando você olha a questão e não sabe por onde começar.
                </p>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <p className="pt-0.5 text-base leading-7 text-white/90 md:text-lg">
                  Como começar a resolver mesmo sem ter certeza.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mx-auto mb-8 w-full max-w-5xl overflow-hidden rounded-2xl border border-white/10 shadow-xl"
          >
          ...
          <motion.p
            ...
            className="mx-auto mb-8 max-w-2xl text-center text-base leading-7 text-muted-foreground md:text-lg"
          >
            Assista aos primeiros minutos e entenda exatamente o que fazer quando você não sabe por onde começar.
          </motion.p>
          ...
          >
            ...
            <a href="#pricing">
              <div className="group flex h-[60px] cursor-pointer items-center gap-2 rounded-full border border-border bg-card p-[10px] transition-all">
                <div className="flex h-[40px] items-center justify-center rounded-full border border-border bg-primary text-primary-foreground">
                  <p className="mx-3 flex items-center justify-center gap-2 text-base font-medium tracking-tight">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
