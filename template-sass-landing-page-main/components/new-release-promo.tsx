...
export function NewReleasePromo() {
  return (
    <section className="relative mt-20 w-full px-4">
      <div className="mx-auto max-w-5xl rounded-[40px] border border-white/10 bg-black/20 p-2 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
        <div className="relative mx-auto min-h-[460px] overflow-hidden rounded-[38px] border border-white/10 px-6 py-14 shadow-sm md:px-10 md:py-16">
          ...
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,#f0b400_0%,#f5c400_25%,#d89f00_55%,#a87400_100%)]" />

          {/* luz superior */}
          <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.30),transparent_70%)]" />

          {/* brilho central */}
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.12),transparent_45%)]" />

          {/* sombra inferior */}
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,transparent_0%,transparent_55%,rgba(0,0,0,0.12)_100%)]" />
          ...
          {/* vinheta suave */}
          <div className="pointer-events-none absolute inset-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-40px_80px_rgba(0,0,0,0.08)]" />
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center text-center">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/90 md:text-xl">
                Comece hoje a treinar matemática com mais direção, mais clareza e mais segurança.
              </p>
              ...
              <svg
                ...
                className="mx-auto mb-6 mt-8 fill-white/90"
              >
              ...
              <div className="flex items-center justify-center">
                ...
                >
                  <div className="group flex h-[66px] cursor-pointer items-center gap-2 rounded-full border border-[#014aad]/40 bg-gradient-to-r from-[#014aad] to-[#123b8f] p-[11px] shadow-[0_10px_30px_rgba(1,74,173,0.4)] transition-all duration-300 hover:scale-[1.02] hover:brightness-110">
                    ...
                    <div className="flex size-[28px] items-center justify-center rounded-full border border-white/30 bg-white/20 text-white transition-all ease-in-out group-hover:ml-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                        height="18"
              ...
              <p className="mx-auto mt-8 max-w-2xl text-sm leading-relaxed text-white/80 md:text-base">
                Banco de questões para treinar matemática com mais direção e menos travamento.
              </p>
            </div>
          </div>
        </div>
